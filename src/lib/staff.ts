...
export const staff: StaffMember[] = [
  {
    ...
    lead: true,
    bio: [
      "Pastor Anthony Aiken and his wife Alaina joined the Liberty Baptist Church family in 2026, and Pastor Aiken was installed as pastor in July of 2026. A graduate of West Coast Baptist College, he brings a heart for clear, Christ-centered preaching from the King James Bible and a passion for reaching people with the Gospel.",
      "The Aikens have two children and love pouring their lives into the church family. Together they are committed to continuing Liberty's legacy as an old-fashioned, gospel-preaching church that welcomes everyone like family.",
...
export const founder = {
  ...
  years: "1978 – 2026",
  bio: [
    "Dr. Gary Jackson founded Liberty Baptist Church on August 6, 1978, and faithfully led the church for more than four decades. Holding a Master of Divinity and a Doctorate of Ministry, he built Liberty on the preaching of God's Word, a heart for missions, and a warm welcome for every visitor.",
