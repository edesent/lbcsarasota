    ...
    <section id="contact" className="py-28 bg-cream">
      <div className="max-w-7xl mx-auto px-6">
        <SectionBadge
          ...
          purpose="Address, embedded map, phone, and directions"
        />
          ...
          <AnimateOnScroll>
            <div className="h-full p-8 md:p-10 bg-warm-white rounded-2xl border border-cream-dark shadow-sm flex flex-col">
              ...
              <div className="space-y-5 mb-8 flex-grow">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+19413718239" className="text-text-dark font-medium hover:text-brown-light transition-colors">
                      (941) 371-8239
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:office@lbcsarasota.com" className="text-text-dark font-medium hover:text-brown-light transition-colors">
                      office@lbcsarasota.com
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  href="https://maps.google.com/?q=4249+Bahia+Vista+Street+Sarasota+FL+34232"
                  target="_blank"
          ...
          <AnimateOnScroll delay={200}>
            <div className="h-full min-h-[400px] rounded-2xl overflow-hidden shadow-sm border border-cream-dark relative bg-cream-dark">
              <iframe
                ...
                src="https://www.google.com/maps?q=4249+Bahia+Vista+Street,+Sarasota,+FL+34232&output=embed"
